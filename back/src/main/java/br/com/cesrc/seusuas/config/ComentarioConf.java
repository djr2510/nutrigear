...
/**
 * Configuração CORS para permitir requisições de diferentes origens para comentários.
 *
 ...
 * para os endpoints relacionados a comentários.
 */
@Configuration
public class ComentarioConf implements WebMvcConfigurer {
