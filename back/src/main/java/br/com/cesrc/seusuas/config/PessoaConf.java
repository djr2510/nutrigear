...
/**
 * Configuração CORS para permitir requisições de diferentes origens para pessoas.
 *
 ...
 * para os endpoints relacionados a pessoas.
 */
@Configuration
public class PessoaConf implements WebMvcConfigurer {
