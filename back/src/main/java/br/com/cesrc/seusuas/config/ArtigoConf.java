...
/**
 * Configuração CORS para permitir requisições de diferentes origens para artigos.
 *
 ...
 * para os endpoints relacionados a artigos.
 */
@Configuration
public class ArtigoConf implements WebMvcConfigurer {
